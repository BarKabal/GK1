...
public class cube {
    ...
    public cube(double x1, double x2, double y1, double y2, double z1, double z2) {
        ...
        p111 = new Point3D(x1,y1,z1); points.add(p111);
        p112 = new Point3D(x1,y1,z2); points.add(p112);
        p121 = new Point3D(x1,y2,z1); points.add(p121);
        p122 = new Point3D(x1,y2,z2); points.add(p122);
        p211 = new Point3D(x2,y1,z1); points.add(p211);
        p212 = new Point3D(x2,y1,z2); points.add(p212);
        p221 = new Point3D(x2,y2,z1); points.add(p221);
        p222 = new Point3D(x2,y2,z2); points.add(p222);
        lines = new ArrayList<>();
